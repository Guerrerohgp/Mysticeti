 ...
 */
function mysticeti_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'mysticeti_content_width', 640 );
}
add_action( 'after_setup_theme', 'mysticeti_content_width', 0 );
 ...
 */
function mysticeti_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'mysticeti' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'mysticeti' ),
...
add_action( 'widgets_init', 'mysticeti_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function mysticeti_scripts() {
	wp_enqueue_style( 'mysticeti-style', get_stylesheet_uri() );
 ...
 * Load Jetpack compatibility file.
 */
require get_template_directory() . '/inc/boot/wp_mysticeti_boot.php';
