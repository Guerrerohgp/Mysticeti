...
function mysticeti_scripts() {	
    ...
    wp_enqueue_script( 'autohidingnavbar', get_template_directory_uri() . '/js/jquery.bootstrap-autohidingnavbar.min.js', array(), '20151215', true );
    wp_enqueue_script( 'mysticeti', get_template_directory_uri() . '/js/mysticeti.js', array(), '20151215', true );
